...
public class SplashScreen extends JFrame {
    ...
    public SplashScreen() {
        ...
        setTitle("Coarta");  // Set the title of the window
        ...
        ImageIcon logoIcon = new ImageIcon("C:\\Users\\lopez\\Downloads\\coarta1.png");  // Insert the directory of the logo here
        ...
        Timer timer = new Timer(3000, e -> {  // Set a 3-second delay
            dispose();  // Close the splash screen
            new LoginWindow();  // Open the login window
        });
        timer.setRepeats(false);  // The timer should only execute once
