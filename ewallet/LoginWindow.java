...
public class LoginWindow extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == loginButton) { // If login button is clicked
            ...
            } else if (AccountManager.accountExists(username)) { // If account already exists
        ...
        public static void main(String[] args) {
            SwingUtilities.invokeLater(LoginWindow::new); // Run the login window in the event dispatch thread
    }
}
